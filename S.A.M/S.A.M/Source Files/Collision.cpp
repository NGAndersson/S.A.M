...
bool Collision::CheckCollision(BoundingSphere Entitiy1, BoundingBox Entity2)
{
	if (Entitiy1.Intersects(Entity2))
		return true;
...
int Collision::CheckIfExplosion(vector<Entity*>* Entity_1, vector<Entity*>* Entity_2)
{
